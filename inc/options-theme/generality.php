...
class avimayeur_generality{
    ...
    public static function render(){
        ?>
            <div class="wrap">
                <h1 class="wp-heagin-inline">A Vi Mayeur</h1>
                <p class="description">
    ...
    public static function registerSettings(){
        ...
        // -> Ajouter les éléments du formulaire
        add_settings_field(
            'logo_avimayeur',                           // SLUG_FIELD
            'Image du logo',                            // LABEL
            [self::class,'field_logo_avimayeur'],       // CALLBACK
            self::GROUP ,                               // SLUG_PAGE
            self::SECTION_IMG                           // SLUG_SECTION
        );
        ...
        // -> Ajouter les éléments du formulaire
        add_settings_field(
            'location_avimayeur',                     // SLUG_FIELD
            'Adresse complète',                       // LABEL
            [self::class,'field_location_avimayeur'], // CALLBACK
            self::GROUP ,                             // SLUG_PAGE
            self::SECTION_INFO                        // SLUG_SECTION
        );
        add_settings_field(
            'phone_avimayeur',                        // SLUG_FIELD
            'Téléhone',                               // LABEL
            [self::class,'field_phone_avimayeur'],    // CALLBACK
            self::GROUP ,                             // SLUG_PAGE
            self::SECTION_INFO                        // SLUG_SECTION
        );
        add_settings_field(
            'mail_avimayeur',                         // SLUG_FIELD
            'E-mail',                                 // LABEL
            [self::class,'field_mail_avimayeur'],     // CALLBACK
            self::GROUP ,                             // SLUG_PAGE
            self::SECTION_INFO                        // SLUG_SECTION
        );
        ...
        // -> Ajouter les éléments du formulaire
        add_settings_field(
            'facebook_avimayeur',                          // SLUG_FIELD
            'Facebook (url)',                              // LABEL
            [self::class,'field_facebook_avimayeur'],      // CALLBACK
            self::GROUP ,                                  // SLUG_PAGE
            self::SECTION_URL                              // SLUG_SECTION
        );

        add_settings_field(
            'instagram_avimayeur',                         // SLUG_FIELD
            'Instagram (url)',                             // LABEL
            [self::class,'field_instagram_avimayeur'],     // CALLBACK
            self::GROUP ,                                  // SLUG_PAGE
            self::SECTION_URL                              // SLUG_SECTION
        );

        add_settings_field(
            'twitter_avimayeur',                           // SLUG_FIELD
            'Twitter (url)',                               // LABEL
            [self::class,'field_twitter_avimayeur'],       // CALLBACK
            self::GROUP ,                                  // SLUG_PAGE
            self::SECTION_URL                              // SLUG_SECTION
        );
    ...
    public static function field_phone_avimayeur(){
    ...
    public static function field_mail_avimayeur(){
    ...
    public static function field_facebook_avimayeur(){
    ...
    public static function field_instagram_avimayeur(){
    ...
    public static function field_twitter_avimayeur(){
...
if(class_exists('avimayeur_generality')){
    avimayeur_generality::register();
}